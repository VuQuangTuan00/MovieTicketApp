...
public final class ItemMenuBinding implements ViewBinding {
  ...
  private ItemMenuBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView imgMenuItem,
  ...
  public static ItemMenuBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.imgMenuItem;
      ImageView imgMenuItem = ViewBindings.findChildViewById(rootView, id);
      if (imgMenuItem == null) {
        break missingId;
      }
      ...
      return new ItemMenuBinding((ConstraintLayout) rootView, imgMenuItem, tvMenuItem);
    }
