...
public final class SignUpLayoutBinding implements ViewBinding {
  ...
  @NonNull
  public final CheckBox ckbAgree;
  ...
  private SignUpLayoutBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnSignUp,
      @NonNull CheckBox ckbAgree, @NonNull ConstraintLayout constraintLayout,
      @NonNull EditText edtEmail, @NonNull CustomEditText edtPassword, @NonNull ImageView imageView,
  ...
  public static SignUpLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.ckbAgree;
      CheckBox ckbAgree = ViewBindings.findChildViewById(rootView, id);
      if (ckbAgree == null) {
        break missingId;
      }
      ...
      id = R.id.edtPassword;
      CustomEditText edtPassword = ViewBindings.findChildViewById(rootView, id);
      if (edtPassword == null) {
        break missingId;
      }
      ...
      return new SignUpLayoutBinding((ConstraintLayout) rootView, btnSignUp, ckbAgree,
          constraintLayout, edtEmail, edtPassword, imageView, imageView2, linearLayout, main,
          textView, textView2, textView3, textView4, textView5, tvSignIn);
    }
