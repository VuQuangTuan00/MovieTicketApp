package com.example.movieticketsapp.custom
...
class RatingSectionView @JvmOverloads constructor(
    ...
    private fun fetchAverageRating() {
        ...
        db.collection("movie")
            ...
            .addOnSuccessListener { snap ->
                ...
                binding.ratingBarSmall.rating = (avg10 / 10.0 * maxStars).toFloat()
    ...
    private fun showRatingDialog() {
        ...
        val starViews = listOf(
            ...
            dialogBinding.star4, dialogBinding.star5, dialogBinding.star6,
            dialogBinding.star7, dialogBinding.star8, dialogBinding.star9,
            dialogBinding.star10
        )
